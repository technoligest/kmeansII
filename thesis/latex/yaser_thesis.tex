...
%TODO: Check if squared distances gives the same result as regular distances. Reword properly.
...
\begin{algorithm}[H]
  ...
  \For{$i=0...T$}{
    runCentres $\leftarrow$ runCentres $\cup$ kmeans.cluster($dataset, k, S$)\;
  }
...
\begin{center}
  ...
  k
  & \multicolumn{1}{c}{\kmeans} & \multicolumn{1}{c}{\kmeansn++} & \multicolumn{1}{c|}{Consensus}
  & \multicolumn{1}{c}{\kmeans} & \multicolumn{1}{c}{\kmeansn++} & \multicolumn{1}{c|}{Consensus}
  & \multicolumn{1}{c}{\kmeans} & \multicolumn{1}{c}{\kmeansn++} & \multicolumn{1}{c|}{Consensus}\\
      \hline
